...
description: "Follow this guide to load custom CSS as a given string when converting an HTML document to PDF with PDFShift's API. This guide provides PHP code samples with the cURL library."
language: 'PHP'
library: 'cURL'
property: 'css'
output: 'pdf'
