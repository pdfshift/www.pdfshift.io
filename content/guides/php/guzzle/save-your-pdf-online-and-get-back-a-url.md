...
description: "This guides shows you how can generate a PDF document from HTML and get back an URL instead of the raw PDF. This allows you to share the link directly to your users or redirect them to that page. Learn how you can achieve it using PHP and the Guzzle library to call PDFShift's API."
language: 'PHP'
library: 'Guzzle'
property: 'filename'
output: 'pdf'
