...
description: "Follow this guide to load custom CSS as a given string when converting an HTML document to PDF with PDFShift's API. This guide provides PHP code samples with the Guzzle library."
language: 'PHP'
library: 'Guzzle'
property: 'css'
output: 'pdf'
