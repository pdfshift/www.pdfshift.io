...
description: "Learn to generate full-height documents dynamically with our step-by-step guide. This will allow you to create documents with a dynamic height, based on the content of the document. This guide provides Ruby code samples using the Faraday library to help you generate full-height documents with PDFShift's API."
language: 'Ruby'
library: 'Faraday'
property: 'format'
output: 'pdf'
