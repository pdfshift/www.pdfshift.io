...
description: "Follow this guide to load custom CSS as a given string when converting an HTML document to PDF with PDFShift's API. This guide provides Ruby code samples with the Faraday library."
language: 'Ruby'
library: 'Faraday'
property: 'css'
output: 'pdf'
