...
description: "Learn how to add text watermarks to your generated PDF document using Ruby and the Typhoeus library. With this guide, you'll be able to add watermarks on top of your generated PDFs easily with a quick request to PDFShift's API."
language: 'Ruby'
library: 'Typhoeus'
property: 'watermark'
output: 'pdf'
