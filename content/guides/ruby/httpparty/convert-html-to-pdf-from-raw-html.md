...
description: "Learn how to to convert raw HTML document to PDF using Ruby and the HttpParty library. Our guide will explain you how to quickly convert documents with PDFShift's API."
language: 'Ruby'
library: 'HttpParty'
output: 'pdf'
...
In this guide, we'll show you how to convert an HTML document to PDF using Ruby and the HttpParty library.
