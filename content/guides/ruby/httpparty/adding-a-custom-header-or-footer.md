...
description: "Discover how to add custom headers or footers to a PDF using Ruby and the HttpParty library. This in-depth guide includes Ruby codes that you can easily follow and quickly generate documents with PDFShift's API."
language: 'Ruby'
library: 'HttpParty'
property: 'header'
output: 'pdf'
...
In this guide, we'll show you how to add custom headers or footers to a PDF using Ruby and the HttpParty library.
