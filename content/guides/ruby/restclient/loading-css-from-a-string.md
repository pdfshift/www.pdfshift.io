...
description: "Follow this guide to load custom CSS as a given string when converting an HTML document to PDF with PDFShift's API. This guide provides Ruby code samples with the RestClient library."
language: 'Ruby'
library: 'RestClient'
property: 'css'
output: 'pdf'
