...
description: "Learn how to export only a specific set of pages from a document using Ruby and the RestClient library. This guide offers detailed steps with code samples in Ruby and the RestClient library, highlighting how you can export only a specific set of pages from a document using PDFShift's API."
language: 'Ruby'
library: 'RestClient'
property: 'pages'
output: 'pdf'
...
In this guide, we'll show you how to export only a specific set of pages from a document using Ruby and the RestClient library to convert them to PDF using PDFShift's API.
