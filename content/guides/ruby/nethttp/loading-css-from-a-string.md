...
description: "Follow this guide to load custom CSS as a given string when converting an HTML document to PDF with PDFShift's API. This guide provides Ruby code samples with the Net::HTTP library."
language: 'Ruby'
library: 'Net::HTTP'
property: 'css'
output: 'pdf'
