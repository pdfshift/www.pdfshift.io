...
description: "Learn to generate full-height documents dynamically with our step-by-step guide. This will allow you to create documents with a dynamic height, based on the content of the document. This guide provides Ruby code samples using the Net::HTTP library to help you generate full-height documents with PDFShift's API."
language: 'Ruby'
library: 'Net::HTTP'
property: 'format'
output: 'pdf'
...
In this guide, we'll show you how to generate a document with full height dynamically using Ruby and the Net::HTTP library to convert them to PDF using PDFShift's API.
