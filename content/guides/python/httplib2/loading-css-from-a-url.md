...
description: "This guides shows you how to add a custom CSS from an URL onto your document to customize the output of your generated PDF. Follow this guides to learn how to do it using Python and the httplib2 library and see how it can quickly be implemented using the PDFShift's API."
language: 'Python'
library: 'httplib2'
property: 'css'
output: 'pdf'
