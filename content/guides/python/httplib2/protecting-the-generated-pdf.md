...
description: "Learn how to protect your generated PDF with encryption for owner and user, and for choosing who can modify, print and/or copy the generated PDF. This guides explains you to do it using Python and the httplib2 library and relies on the PDFShift's API."
language: 'Python'
library: 'httplib2'
property: 'protection'
output: 'pdf'
...
In this guide, we'll show you how you can protect your generated PDF with encryption for owner and user, and for choosing who can modify, print and/or copy the generated PDF. This guides explains you to do it using Python and the httplib2 library and relies on the PDFShift's API.
