...
description: "Discover how to effortlessly add image watermarks to PDFs using Python and the urllib3 library. Our guide shows you how to add images on top of your PDF to protect your document easily. This is easily done with a simple request to PDFShift's API."
language: 'Python'
library: 'urllib3'
property: 'watermark'
output: 'pdf'
