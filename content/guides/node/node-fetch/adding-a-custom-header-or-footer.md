...
description: "Discover how to add custom headers or footers to a PDF using Node and the NodeFetch library. This in-depth guide includes Node codes that you can easily follow and quickly generate documents with PDFShift's API."
language: 'Node'
library: 'NodeFetch'
property: header
output: 'pdf'
...
In this guide, we'll show you how to add custom headers or footers to a PDF using Node and the NodeFetch library.
