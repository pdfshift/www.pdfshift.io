...
description: "Follow this guide to learn how to add custom javascript to your page to customize the output of your generated PDF. This allows you to modify elements on the page, add or remove content, etc. This guide uses Node and the NodeFetch library and relies on the PDFShift's API."
language: 'Node'
library: 'NodeFetch'
property: javascript
output: 'pdf'
