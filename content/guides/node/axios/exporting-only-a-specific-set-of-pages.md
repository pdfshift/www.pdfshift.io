...
description: "Learn how to export only a specific set of pages from a document using Node and the Axios library. This guide offers detailed steps with code samples in Node and the Axios library, highlighting how you can export only a specific set of pages from a document using PDFShift's API."
language: 'Node'
library: 'Axios'
property: pages
output: 'pdf'
...
In this guide, we'll show you how to export only a specific set of pages from a document using Node and the Axios library to convert them to PDF using PDFShift's API.
