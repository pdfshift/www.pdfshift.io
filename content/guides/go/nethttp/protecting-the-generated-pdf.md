...
description: "Learn how to protect your generated PDF with encryption for owner and user, and for choosing who can modify, print and/or copy the generated PDF. This guides explains you to do it using Go and the Net/HTTP library and relies on the PDFShift's API."
language: 'Go'
library: 'Net/HTTP'
property: 'protection'
output: 'pdf'
