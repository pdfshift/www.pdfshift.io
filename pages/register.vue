<template>
    <div>
        <NuxtLayout name="page-bg">
            <PageHeader title="Quickly get started" v-if="!success">
...
const languageLabel = computed(() => {
    const option = languageOptions.find(option => option.value === form.value.language)
    return option ? option.label : 'PHP'
