<template>
    <section class="py-8 lg:py-8 ">
        ...
        <div class="pt-16 py-32 max-w-5xl mx-auto">
            <ol>
                <li v-for="(faq, key) in faqsLeft" :key="key" class="border-b border-navy-700 py-4 text-navy-700" itemscope itemtype="https://schema.org/Question">
                    ...
                    <div v-show="faq.visible" class="p -small py-4 pl-12 pr-4" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
                        <div v-html="faq.answer" itemprop="text"></div>
                    </div>
                </li>
            </ol>
            <div class="pt-16" itemscope itemtype="https://schema.org/Question">
                <div class="h3" itemprop="name">What if I have other questions?</div>
                <div class="p py-4" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
                    <div itemprop="text">
