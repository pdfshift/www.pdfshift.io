    ...
    <div>
        <header>
            <div>
                ...
                <h1>
                    Privacy Policy
                    <small>Last Edited on 2018-02-24</small>
                </h1>
            </div>
        </header>
        ...
        <div class="container">
            <div class="page">
                <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the https://www.pdfshift.io website (the "Service") operated by PDFShift ("us", "we", or "our").</p>
                ...
                <div>
                   ...
                   <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by PDFShift.</p>
                   <p>PDFShift has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that PDFShift shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
                ...
                <div>
                   <h2>Contact Us</h2>
                   <p>If you have any questions about these Terms, please contact us using <a href="mailto:support@pdfshift.io" target="_blank">support@pdfshift.io</a>.</p>
                </div>
            </div>
        </div>
    </div>
