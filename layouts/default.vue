                        ...
                        <div class="row" itemtype="http://schema.org/SiteNavigationElement">
                            ...
                            <nav id="header-main-menu" ref="header-main-menu" class="column" :class="{'visible': showAccordionMenu}">
                                <ul itemscope="itemscope">
                                    ...
                                    <li>
                                        <a href="https://docs.pdfshift.io/" title="Read our documentation" itemprop="name" target="_blank" rel="noreferer,noopener">
                                            Docs <SvgOutsideLink />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://status.pdfshift.io/" title="View our running status" itemprop="name" target="_blank" rel="noreferer,noopener">
            ...
            <div class="container">
                ...
                <div class="row disclaimer">
                    ...
                    <div class="column three">
                        <ul class="unstyled">
                            <li class="twitter">
                                <a href="https://twitter.com/pdfshift" title="View our Twitter page" target="_blank" rel="noreferer,noopener">
